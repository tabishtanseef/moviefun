...
<body>
    ...
    <div class="page_container">
        ...
        <div class="wrap block carousel_block">
            <div class="container">
            	<h2 class="upper">Your Movies are here.</h2>
            	<div class="row">
                    <div class="span12">
				...
				$get_products= "select * from movie where movie_keywords like '%$city%'";
                         ...
                         echo "
                            ...
                            <li>
                            	<div class='post_carousel'>
                                    ...
                                    <div>
                                		 <a href='#'>$cat</a> In <a href='#'>$gen</a>
                                    </div>
									 <div >
                                		 <a href='#'>$desc</a> Between <a href='#'>$link</a>
                                    </div>
